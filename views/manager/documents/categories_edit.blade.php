...
@section('content')
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-md-12">
			<div class="x_panel">
                 <div class="x_title">
					<h2><a href="/manager/documents-categories"><u>Categories</u></a> -> Edit/Add</h2>
					<div class="clearfix"></div>
				</div>
                <div class="x_content">
				
				<form action="/manager/documents-categories-add" method="post" enctype="multipart/form-data">
