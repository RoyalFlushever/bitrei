            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
				...
				<? if(Auth::user()->user_type == 21){ ?>
				  ...
				  <li><a href="/admin/property-list"><i class="fa fa-flag"></i>Property List</a></li>
				  
                  <li><a href="/admin/transaction-list"><i class="fa fa-flag"></i>Transactions</a></li>
				  
                  <li><a href="/admin/blog-pages"><i class="fa fa-flag"></i> Web pages</a></li>
				  
				  <li><a href="/admin/bank-data-list"><i class="fa fa-flag"></i> Bank Data</a></li>
				  ...
				  <li><a href="/common/user-list"><i class="fa fa-gift"></i> Users </a></li>
