        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <a href="/admin/property-details?id=<? if(isset($data[0])){ ?>{{ $data[0]->id }}<? } ?>" class="btn btn-primary pull-right">Property details</a>
					...
					<form action="/admin/property-add-update" method="post" enctype="multipart/form-data">
						...
						<!--<div class="col-sm-12 col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="thumbnail" value="" placeholder="thumbnail">
							</div>
						</div>-->
						...
						<div class="col-sm-12 col-md-12">
							<div class="form-group">
								...
								<input type="checkbox" name="is_featured" value="1" <? if(isset($data[0]) && $data[0]->is_featured == 1){ echo "checked='checked'"; }?>>
							</div>
						</div>
						
						<div class="col-sm-12 col-md-12">
							<div class="form-group">
								<label>Is on homepage?</label>
